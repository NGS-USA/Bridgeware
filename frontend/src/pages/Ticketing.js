    ...
    <div className="p-8">
      ...
      {tickets.length === 0 ? (
        ...
        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
          {tickets.map(ticket => (
            <div key={ticket.id} onClick={() => navigate(`/ticketing/${ticket.id}`)} className="flex items-center gap-4 px-4 py-3 border-b border-gray-100 hover:bg-gray-50 cursor-pointer">
