    ...
    <div className="p-8">
      ...
      <div className="grid grid-cols-4 gap-4 mb-8">
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          ...
          <div className="text-2xl font-medium text-gray-900">{tickets?.length ?? 0}</div>
        </div>
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="text-xs text-gray-500 font-medium uppercase tracking-wide mb-1">Companies</div>
          <div className="text-2xl font-medium text-gray-900">{companies?.length ?? 0}</div>
        </div>
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="text-xs text-gray-500 font-medium uppercase tracking-wide mb-1">Invoices</div>
          <div className="text-2xl font-medium text-gray-900">{invoices?.length ?? 0}</div>
        </div>
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="text-xs text-gray-500 font-medium uppercase tracking-wide mb-1">Active projects</div>
          <div className="text-2xl font-medium text-gray-900">{projects?.length ?? 0}</div>
        </div>
      </div>
