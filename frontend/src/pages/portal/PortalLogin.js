    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="bg-white border border-gray-200 rounded-lg p-8 w-full max-w-sm">
        <div className="flex items-center gap-2 mb-8">
          ...
          <span className="text-gray-900 font-medium">Bridgeware Client Portal</span>
        </div>
        <h1 className="text-lg font-medium text-gray-900 mb-1">Sign in</h1>
        <p className="text-sm text-gray-400 mb-6">Sign in to view your tickets, invoices, and more.</p>
        {error && (
